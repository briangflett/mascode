  ...
  public function run()
  {
    ...
    foreach ($sr_results as $sr) {
      ...
      if ($count == 0) {
        ...
        // Add the missing SR if it does not exist
        ...
        if (!empty($sr->ClientID_Clean)) {
          ...
          echo "Added service request $sr->RequestID for client $sr->ClientID new ID $sr->ClientID_Clean.  <br>";
        } else {
    ...
    $url = site_url('/wp-content/uploads/civicrm/ext/mascode/extern/sr_add_missing.php?last_id=' . urlencode($last_id));
